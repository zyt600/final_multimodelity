...
from loader.ucf_loader import UCF_DataLoader
...
def main(args):
    ...
    test_dataset = UCF_DataLoader(data='./data/ucf.csv', num_clip=args.num_windows_test, video_root=args.eval_video_root,
